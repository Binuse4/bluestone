      ...
      <div className={`cart-drawer-overlay ${isOpen ? 'open' : ''}`} onClick={onClose}>
        <div className="cart-drawer nordic-cart" onClick={(e) => e.stopPropagation()} ref={cartRef}>
          <div className="cart-drawer-header" style={{ borderBottom: '1px solid #E2E8F0', padding: '30px 24px' }}>
            <h3 className="nordic-cart-title" style={{ fontSize: '1.1rem', margin: 0 }}>Shopping Cart ({cartCount})</h3>
          ...
          <div className="cart-drawer-body">
            {cart.length === 0 ? (
              <div className="cart-empty-state">
                <p style={{ color: '#718096', textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.85rem' }}>Your cart is empty.</p>
                <button onClick={onClose} style={{ marginTop: '20px', background: 'none', border: '1px solid #1a202c', color: '#1a202c', padding: '10px 25px', textTransform: 'uppercase', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer' }}>Continue Shopping</button>
              </div>
            ) : (
              cart.map((item) => (
          ...
          {cart.length > 0 && (
            <div className="cart-drawer-footer" style={{ backgroundColor: '#fff', borderTop: '1px solid #E2E8F0', padding: '30px 24px' }}>
              ...
              <p className="cart-drawer-note" style={{ textAlign: 'center', marginTop: 15, fontSize: '0.7rem', color: '#A0AEC0', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Download your cart as PNG before ordering.</p>
            </div>
          )}
        </div>
      </div>
